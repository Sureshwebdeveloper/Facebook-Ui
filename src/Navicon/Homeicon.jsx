...
const Homeicon = ({ hover, HoverColor }) => {
  return (
    <div
      className="hover:bg-[#cccccc96] md:px-2 px-5 py-2 rounded-md cursor-pointer hidden md:block lg:block xl:block 2xl:block"
      onClick={HoverColor}
    >
